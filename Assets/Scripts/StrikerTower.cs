...
public class StrikerTower : Tower
{
    ...
    public override void Fire()
    {
        try
        {
            ...
            float x = position.x;
            GameObject projectile = Instantiate(ProjectileManager.instance.strikerRound,
            ...
            ball.damage = damage;
            if (ball != null)
                ball.Seek(target.transform, ProjectileType.STRIKE);
        }
        catch (Exception e)
        {
            return;
